...
@implementation TSReplyheadCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.replyTextLabel.text = @"我发过的内容，我发过的内容，我发过的内容，我发过的内容，我发过的内容，";
        //self.replyTextLabel.textAlignment = UITextAlignmentLeft;
        self.replyTextLabel.textColor = [ UIColor blackColor];
        self.replyTextLabel.font = [ UIFont fontWithName: @"Arial" size: 12.0 ];
